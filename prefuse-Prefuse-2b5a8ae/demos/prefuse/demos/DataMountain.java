...
public class DataMountain extends Display {
    ...
    public static JComponent demo() {
        String datafile = "C:/Users/sakshi/workspace/prefuse/prefuse-Prefuse-2b5a8ae/demos/prefuse/amazon.txt";
        Table data = null;
        try {
            data = (new DelimitedTextTableReader()).readTable(datafile);
            data.addColumn("image","CONCAT('C:/Users/sakshi/workspace/prefuse/prefuse-Prefuse-2b5a8ae/data/images',id,'.01.MZZZZZZZ.jpg')");
        } catch (Exception e) {
            e.printStackTrace();
            System.exit(1);
        }
